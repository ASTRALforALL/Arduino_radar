...
void loop() {
  ...
  for (int i = 0; i <= 90; i++) {
    ...
    Serial.println(distance);  // Sends the distance value into the Serial Port      // Sends addition character right next to the previous value needed later in the Processing IDE for indexing
  }
